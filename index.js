...
const descriptions = [
    ...
    {id: 5, description: 'Мы оба повзрослеем прежде, чем узнаем о цене этой трансгрессии. Начав со взаимной' +
            ...
            ' когда-то сwкрепленные обстоятельствами и переплетением событий.'},
    ...
    {id: 8, description: 'Послемрак. Она всегда учила меня всматриваться в мелочи, но не скажу, что я хотя бы раз' +
            ' прислушивался. Попытка. Я закрываю глаза, чтобы увидеть укрывшиеся под наэлектризованным одеялом' +
    ...
    {id: 9, description: 'Отрезок света. Мы близки к финалу, отчего история заиграла новыми красками. Да, люблю.' +
            ' Но отпущу, как и всё, что сейчас не хотел бы. Брошу пить. Брошу писать. С этого момента она - не' +
            ' более, чем струны. Причина письма, но уже не его адресат.'},
    {id: 10, description: 'Воспоминания. Чересчур идеальные, чтобы им хотелось верить. Свойство памяти сглаживать' +
